...
var _ThreeDScene = __webpack_require__(9);

var _ThreeDScene2 = _interopRequireDefault(_ThreeDScene);
...
/* --- Once every promise is resolved sart seting up the task--- */
  ...
  taskObject.registerSceneGenerator(_ThreeDScene2.default);

  var sceneNames = ['loading', 'main', 'threeD'];
...
function MainScene() {
  ...
  var selectLevel = function selectLevel() {
    ...
    var eventButton3D = new _experimentJs.EventData(R.get.events_goTo3D, stateManager.timeInMs);
    ...
    return Promise.all([stateManager.promise('addButton', buttonOptionLevelOne), stateManager.promise('addButton', buttonOptionTutorialOne)]).then(function (buttons) {
  ...
  stateManager.states.active.addEventFunctions(R.get.events_goTo3D, function () {
    taskObject.currentScene = 'threeD';
  }
...
function ThreeDScene() {
  ...
  var scene = new _experimentBabylonJs2.default.Scene(taskObject.engine);
  ...
  scene.updateContentFrame = function () {};
  ...
  );var camera = new _experimentBabylonJs2.default.ArcRotateCamera('camera1', 0, 1.05, 25, new _experimentBabylonJs2.default.Vector3(0, 0, 0), scene);
  camera.setTarget(_experimentBabylonJs2.default.Vector3.Zero());
  ...
  var light = new _experimentBabylonJs2.default.PointLight('light1', new _experimentBabylonJs2.default.Vector3(0, -1, 0), scene);
  light.position = new _experimentBabylonJs2.default.Vector3(-3, 5, -3); // only Y is not updated in render
  light.intensity = 0.95;
  light.diffuse = new _experimentBabylonJs2.default.Color3(1, 0, 0);
  light.specular = new _experimentBabylonJs2.default.Color3(1, 1, 1);

  var lightSphere = _experimentBabylonJs2.default.Mesh.CreateSphere('sphere1', 30, 0.5, scene);
  var litMaterial = new _experimentBabylonJs2.default.StandardMaterial('litMat', this.scene);
  litMaterial.emissiveColor = _experimentBabylonJs2.default.Color3.FromInts(255, 300, 150);
  lightSphere.material = litMaterial;

  // Lights
  var light0 = new _experimentBabylonJs2.default.PointLight('light5', new _experimentBabylonJs2.default.Vector3(0, -1, 0), scene);
  var light1 = new _experimentBabylonJs2.default.PointLight('Omni1', new _experimentBabylonJs2.default.Vector3(0, -1, 0), scene);
  var light2 = new _experimentBabylonJs2.default.PointLight('Omni2', new _experimentBabylonJs2.default.Vector3(0, -1, 0), scene);
  var light3 = new _experimentBabylonJs2.default.PointLight('Dir0', new _experimentBabylonJs2.default.Vector3(0, -1, 0), scene);
  var light4 = new _experimentBabylonJs2.default.PointLight('Omni3', new _experimentBabylonJs2.default.Vector3(0, -1, 0), scene);
  var light5 = new _experimentBabylonJs2.default.PointLight('Omni4', new _experimentBabylonJs2.default.Vector3(0, -1, 0), scene);

  // Creating light sphere
  var lightSphere0 = _experimentBabylonJs2.default.Mesh.CreateSphere('Sphere0', 16, 0.5, scene);
  var lightSphere1 = _experimentBabylonJs2.default.Mesh.CreateSphere('Sphere1', 16, 0.5, scene);
  var lightSphere2 = _experimentBabylonJs2.default.Mesh.CreateSphere('Sphere2', 16, 0.5, scene);
  var lightSphere4 = _experimentBabylonJs2.default.Mesh.CreateSphere('Sphere4', 16, 0.5, scene);
  var lightSphere5 = _experimentBabylonJs2.default.Mesh.CreateSphere('Sphere5', 16, 0.5, scene);

  lightSphere0.material = new _experimentBabylonJs2.default.StandardMaterial('red', scene);
  // lightSphere0.material.diffuseColor = new BABYLON.Color3(0, 0, 0);
  // lightSphere0.material.specularColor = new BABYLON.Color3(0, 0, 0);
  lightSphere0.material.emissiveColor = new _experimentBabylonJs2.default.Color3(1, 0, 0);
  light0.intensity = 0.95;

  lightSphere1.material = new _experimentBabylonJs2.default.StandardMaterial('green', scene);
  lightSphere1.material.diffuseColor = new _experimentBabylonJs2.default.Color3(0, 1, 0);
  lightSphere1.material.specularColor = new _experimentBabylonJs2.default.Color3(0, 1, 0);
  lightSphere1.material.emissiveColor = new _experimentBabylonJs2.default.Color3(0, 1, 0);

  lightSphere2.material = new _experimentBabylonJs2.default.StandardMaterial('blue', scene);
  lightSphere2.material.diffuseColor = new _experimentBabylonJs2.default.Color3(0, 0, 1);
  lightSphere2.material.specularColor = new _experimentBabylonJs2.default.Color3(0, 0, 0);
  lightSphere2.material.emissiveColor = new _experimentBabylonJs2.default.Color3(0, 0, 1);

  lightSphere4.material = new _experimentBabylonJs2.default.StandardMaterial('blue', scene);
  lightSphere4.material.diffuseColor = new _experimentBabylonJs2.default.Color3(0, 0, 0);
  lightSphere4.material.specularColor = new _experimentBabylonJs2.default.Color3(0, 0, 0);
  lightSphere4.material.emissiveColor = new _experimentBabylonJs2.default.Color3(1, 1, 0);

  lightSphere5.material = new _experimentBabylonJs2.default.StandardMaterial('blue', scene);
  lightSphere5.material.diffuseColor = new _experimentBabylonJs2.default.Color3(0, 0, 0);
  lightSphere5.material.specularColor = new _experimentBabylonJs2.default.Color3(0, 0, 0);
  lightSphere5.material.emissiveColor = new _experimentBabylonJs2.default.Color3(0, 1, 1);

  // Lights colors
  light0.diffuse = new _experimentBabylonJs2.default.Color3(1, 0, 0);
  light0.specular = new _experimentBabylonJs2.default.Color3(1, 0, 0);

  light1.diffuse = new _experimentBabylonJs2.default.Color3(0, 1, 0);
  light1.specular = new _experimentBabylonJs2.default.Color3(0, 1, 0);

  light2.diffuse = new _experimentBabylonJs2.default.Color3(0, 0, 1);
  light2.specular = new _experimentBabylonJs2.default.Color3(0, 0, 1);

  light3.diffuse = new _experimentBabylonJs2.default.Color3(1, 1, 1);
  light3.specular = new _experimentBabylonJs2.default.Color3(1, 1, 1);

  light4.diffuse = new _experimentBabylonJs2.default.Color3(1, 1, 0);
  light4.specular = new _experimentBabylonJs2.default.Color3(1, 1, 0);

  light5.diffuse = new _experimentBabylonJs2.default.Color3(0, 1, 1);
  light5.specular = new _experimentBabylonJs2.default.Color3(0, 1, 1);

  // Our built-in 'sphere' shape. Params: name, subdivs, size, scene
  var sphere = _experimentBabylonJs2.default.Mesh.CreateSphere('sphere1', 150, 2, scene);
  sphere.position.y = 1;

  var sphere2 = _experimentBabylonJs2.default.Mesh.CreateSphere('sphere2', 150, 2, scene);
  sphere2.position.y = 1;
  sphere2.position.z = 3;

  // Our built-in 'ground' shape. Params: name, width, depth, subdivs, scene
  var ground = _experimentBabylonJs2.default.Mesh.CreateGround('ground1', 60, 60, 2, scene);

  var shadowGenerator = new _experimentBabylonJs2.default.ShadowGenerator(1024, light);
  light.shadowMinZ = 1;
  ...
  var shadowGenerator2 = new _experimentBabylonJs2.default.ShadowGenerator(1024, light0);
  ...
  var matt = new _experimentBabylonJs2.default.StandardMaterial('texture1', scene);
  ...
  scene.clearColor = new _experimentBabylonJs2.default.Color4(0.5, 0.8, 1, 1);

  // Animations
  var alpha = 0;
  var radiansFromCameraForShadows = -3 * (Math.PI / 4);
  var beta = 0;
  ...
  scene.beforeRender = function () {
    ...
    light0.position = new _experimentBabylonJs2.default.Vector3(10 * Math.sin(alpha), 0, 10 * Math.cos(alpha));
    light1.position = new _experimentBabylonJs2.default.Vector3(10 * Math.sin(alpha), 0, -10 * Math.cos(alpha));
    light2.position = new _experimentBabylonJs2.default.Vector3(10 * Math.cos(alpha), 0, 10 * Math.sin(alpha));
    light4.position = new _experimentBabylonJs2.default.Vector3(10 * Math.cos(alpha), 10 * Math.sin(alpha), 0);
    light5.position = new _experimentBabylonJs2.default.Vector3(10 * Math.sin(alpha), -10 * Math.cos(alpha), 0);
